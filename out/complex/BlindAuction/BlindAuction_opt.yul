    ...
    code {
        {
            ...
            let _1 := datasize("BlindAuction_376_deployed")
            codecopy(0, dataoffset("BlindAuction_376_deployed"), _1)
            return(0, _1)
        }
        ...
        code {
            {
                ...
                if iszero(lt(calldatasize(), 4))
                {
                    ...
                    case 0x423b217f {
                        ...
                        return(memPos_3, sub(abi_encode_uint256(memPos_3, _3), memPos_3))
                    }
                    case 0x900f080a {
                        if callvalue() { revert(_2, _2) }
                        let param_2, param_3, param_4 := abi_decode_array_uint256_dynt_array_bool_dynt_array_bytes32_dyn(calldatasize())
                        modifier_onlyAfter_140(param_2, param_3, param_4)
                        return(mload(_1), _2)
                    }
                    case 0x91f90157 {
                        if callvalue() { revert(_2, _2) }
                        abi_decode(calldatasize())
                        let ret_4 := and(sload(5), sub(shl(160, 1), 1))
                        let memPos_4 := mload(_1)
                        return(memPos_4, sub(abi_encode_address(memPos_4, ret_4), memPos_4))
                    }
                    case 0x957bb1e0 {
                    ...
                    case 0xa6e66477 {
                        ...
                        return(memPos_5, sub(abi_encode_uint256(memPos_5, _4), memPos_5))
                    }
                    case 0xd57bde79 {
                        if callvalue() { revert(_2, _2) }
                        abi_decode(calldatasize())
                        ...
                        return(memPos_6, sub(abi_encode_uint256(memPos_6, _5), memPos_6))
                    }
                }
                revert(0, 0)
            }
            ...
            function abi_decode_array_uint256_dynt_array_bool_dynt_array_bytes32_dyn(dataEnd) -> value0, value1, value2
            {
                ...
                if iszero(slt(add(offset, 35), dataEnd)) { revert(value2, value2) }
                ...
                if gt(add(add(offset, shl(5, _2)), 36), dataEnd) { revert(value2, value2) }
                let i := value2
            ...
            function finalize_allocation_4149(memPtr)
            {
            ...
            function fun_withdraw()
            {
                ...
                if iszero(_3)
                {
                    ...
                    let _4 := _1
                    if _3 { _4 := 2300 }
                    if iszero(call(_4, caller(), _2, _1, _1, _1, _1))
                    {
            ...
            {
                mstore(ret, and(key, sub(shl(160, 1), 1)))
                mstore(0x20, 4)
                let dataSlot := keccak256(ret, 0x40)
                if iszero(lt(key_1, sload(dataSlot))) { revert(ret, ret) }
            ...
            function modifier_onlyAfter_140(var_values_mpos, var_fake_mpos, var_secret_mpos)
            {
                let _1 := 0x01
                let _2 := sload(_1)
                ...
                }
                {
                    ...
                    let returnValue := mload(memory_array_index_access_bool_dyn(var_values_mpos, var_i))
                    let _8 := read_from_memoryt_bool(memory_array_index_access_bool_dyn(var_fake_mpos, var_i))
                    let returnValue_1 := mload(memory_array_index_access_bool_dyn(var_secret_mpos, var_i))
                    let _9 := sload(_6)
                    let expr_mpos := mload(64)
                    let _10 := add(expr_mpos, 0x20)
                    let _11 := sub(abi_encode_packed_uint256_bool_bytes32(_10, returnValue, _8, returnValue_1), expr_mpos)
                    mstore(expr_mpos, add(_11, not(31)))
                    finalize_allocation(expr_mpos, _11)
                    if iszero(eq(_9, keccak256(_10, mload(expr_mpos)))) { continue }
                    let _12 := sload(add(_6, _1))
                    var_refund := checked_add_uint256(var_refund, _12)
                    let expr := iszero(_8)
                    if expr
                    {
                        expr := iszero(lt(_12, returnValue))
                    }
                    if expr
                    {
                        if fun_placeBid(caller(), returnValue)
                        {
                            var_refund := checked_sub_uint256(var_refund, returnValue)
                        }
                    }
                    update_storage_value_offsett_bytes32_to_bytes32(_6)
                }
                let _13 := 0
                if iszero(var_refund) { _13 := 2300 }
                if iszero(call(_13, caller(), var_refund, 0, 0, 0, 0)) { revert_forward() }
            }
            function modifier_onlyAfter()
            {
                ...
                let _4 := sload(0x06)
                let _5 := mload(64)
                log1(_5, sub(abi_encode_address_uint256(_5, cleaned, _4), _5), 0xdaec4582d5d9595688c8c98545fdd1c696d41c6aeaeb636737e84ed2f5c00eda)
            ...
            function modifier_onlyBefore(var_blindedBid)
            {
                ...
                finalize_allocation_4149(memPtr)
            ...
            function update_storage_value_offsett_bytes32_to_bytes32(slot)
            { sstore(slot, 0) }
        }
    }
}
